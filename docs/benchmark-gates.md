...
4. `mc_cpu_european_call_rust`, `mc_cpu_down_and_out_call_rust`, `mc_cpu_lookback_call_rust`, and `mc_cpu_heston_european_call_rust` must be present in benchmark results.
