...
Current Rust fair baseline (`mc_cpu_european_call_rust`, step-wise): `14.491 ms`
...
- Preserve the specialized terminal-distribution fast path (`0.637 ms`) as a separate optimization track.
