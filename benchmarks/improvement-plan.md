...
Current Rust fair baseline (`mc_cpu_european_call_rust`, step-wise): `18.520 ms`
...
- Preserve the specialized terminal-distribution fast path (`0.756 ms`) as a separate optimization track.
