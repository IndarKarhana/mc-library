...
Current Rust fair baseline (`mc_cpu_european_call_rust`, step-wise): `21.702 ms`
...
- Preserve the specialized terminal-distribution fast path (`0.987 ms`) as a separate optimization track.
