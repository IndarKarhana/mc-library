...
- `mc_cpu_european_call_rust` (`stepwise_paths`): `13.865 ms` per run, price `9.430456`
...
- `mc_cpu_down_and_out_call_rust` (`down_and_out_stepwise`): `22.065 ms` per run
- `mc_cpu_lookback_call_rust` (`lookback_fixed_strike_stepwise`): `18.516 ms` per run, price `16.671609`
- `mc_cpu_lookback_call_rust_control_variate` (`lookback_fixed_strike_stepwise_control_variate`): `19.477 ms` per run, price `16.649141`
...
- `mc_metal_european_call_native` (`stepwise_paths_native_metal`): `1.043 ms` per run
...
- `mc_cpu_european_call_numpy` (`stepwise_paths`): `75.027 ms` per run, price `9.486909`
- `mc_cpu_european_call_numba` (`stepwise_paths`): `235.428 ms` per run, price `9.374554`
...
- `mc_cpu_qmc_rust_scrambled_sobol_generation`: `73.404 ms` per run, `normal_mean_abs = 0.000004`
- `mc_cpu_qmc_scipy_qmc_sobol_generation`: `121.515 ms` per run, `normal_mean_abs = 0.000002`
- `mc_cpu_qmc_rust_randomized_halton_generation`: `55.184 ms` per run, `normal_mean_abs = 0.000063`
- `mc_cpu_qmc_scipy_qmc_halton_generation`: `144.278 ms` per run, `normal_mean_abs = 0.000017`
- `mc_cpu_qmc_rust_latin_hypercube_generation`: `38.964 ms` per run, `normal_mean_abs = 0.000000`
- `mc_cpu_qmc_scipy_qmc_lhs_generation`: `194.936 ms` per run, `normal_mean_abs = 0.000000`
...
- `mc_cpu_gaussian_uncertainty_rust_pseudorandom`: `3.233 ms` per run, `abs_error_vs_analytic_mean = 0.006344`
- `mc_cpu_gaussian_uncertainty_rust_latin_hypercube`: `2.107 ms` per run, `abs_error_vs_analytic_mean = 0.000039`
