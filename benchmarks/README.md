...
- `mc_cpu_european_call_rust` (`stepwise_paths`): `13.269 ms` per run
- `mc_cpu_european_call_rust_antithetic` (`stepwise_paths_antithetic`): `28.091 ms` per run
- `mc_cpu_european_call_rust_antithetic_quality`: `stderr_ratio_vs_standard = 0.747`
- `mc_cpu_european_call_rust_control_variate` (`stepwise_paths_control_variate`): `12.596 ms` per run
- `mc_cpu_european_call_rust_control_variate_quality`: `stderr_ratio_vs_standard = 0.411`
- `mc_cpu_arithmetic_asian_call_rust` (`arithmetic_asian_stepwise`): `16.317 ms` per run
- `mc_cpu_arithmetic_asian_call_rust_control_variate` (`arithmetic_asian_stepwise_control_variate`): `16.376 ms` per run
- `mc_cpu_arithmetic_asian_call_rust_control_variate_quality`: `stderr_ratio_vs_standard = 0.607`
- `mc_cpu_arithmetic_asian_call_rust_mlmc` (`arithmetic_asian_multilevel_coupled_adaptive_tolerance`): `4.528 ms` per run
- `mc_cpu_arithmetic_asian_call_rust_mlmc_quality`: `stderr_ratio_vs_standard = 2.013`
- `mc_cpu_arithmetic_asian_call_rust_mlqmc` (`arithmetic_asian_multilevel_scrambled_sobol_replicated_adaptive_tolerance`): `5.755 ms` per run
...
- `mc_cpu_european_call_rust_randomized_halton` (`stepwise_paths_randomized_halton`): `78.311 ms` per run
- `mc_cpu_european_call_rust_randomized_halton_control_variate_quality`: `stderr_ratio_vs_standard = 0.411`
- `mc_cpu_european_call_rust_latin_hypercube` (`stepwise_paths_latin_hypercube`): `65.046 ms` per run
- `mc_cpu_european_call_rust_latin_hypercube_control_variate_quality`: `stderr_ratio_vs_standard = 0.410`
- `mc_cpu_european_call_rust_scrambled_sobol` (`stepwise_paths_scrambled_sobol`): `80.240 ms` per run
- `mc_cpu_european_call_rust_scrambled_sobol_brownian_bridge` (`stepwise_paths_scrambled_sobol_brownian_bridge`): `104.042 ms` per run
...
- `mc_cpu_down_and_out_call_rust` (`down_and_out_stepwise`): `19.072 ms` per run
- `mc_cpu_down_and_out_call_rust_control_variate` (`down_and_out_stepwise_control_variate`): `22.072 ms` per run
...
- `mc_cpu_basket_call_rust` (`basket_terminal_pseudorandom`): `3.985 ms` per run
- `mc_cpu_basket_call_rust_randomized_halton` (`basket_terminal_randomized_halton`): `8.178 ms` per run
- `mc_cpu_basket_call_rust_latin_hypercube` (`basket_terminal_latin_hypercube`): `3.982 ms` per run
- `mc_cpu_basket_call_rust_scrambled_sobol` (`basket_terminal_scrambled_sobol`): `7.167 ms` per run
...
- `mc_cpu_european_call_rust_terminal` (`terminal_distribution`): `0.492 ms` per run
...
- `mc_metal_european_call_native` (`stepwise_paths_native_metal`): `1.684 ms` per run
...
- `mc_metal_european_call_native_control_variate` (`stepwise_paths_native_metal_control_variate`): `1.666 ms` per run
- `mc_metal_european_call_native_control_variate_quality`: `stderr_ratio_vs_standard = 0.409`
- `mc_metal_arithmetic_asian_call_native` (`arithmetic_asian_stepwise_native_metal`): `0.677 ms` per run
- `mc_metal_arithmetic_asian_call_native_control_variate` (`arithmetic_asian_stepwise_native_metal_control_variate`): `0.683 ms` per run
- `mc_metal_arithmetic_asian_call_native_control_variate_quality`: `stderr_ratio_vs_standard = 0.609`
- `mc_metal_down_and_out_call_native` (`down_and_out_stepwise_native_metal`): `0.693 ms` per run
- `mc_metal_down_and_out_call_native_control_variate` (`down_and_out_stepwise_native_metal_control_variate`): `0.724 ms` per run
- `mc_metal_down_and_out_call_native_control_variate_quality`: `stderr_ratio_vs_standard = 0.417`
- `mc_cpu_european_call_numpy` (`stepwise_paths`): `77.161 ms` per run
- `mc_cpu_european_call_numba` (`stepwise_paths`): `220.591 ms` per run
- `mc_cpu_qmc_rust_scrambled_sobol_generation` (`standard_normal_generation_scrambled_sobol`): `74.359 ms` per run, `normal_mean_abs = 0.000004`
- `mc_cpu_qmc_scipy_qmc_sobol_generation` (`standard_normal_generation_scrambled_sobol`): `120.144 ms` per run, `normal_mean_abs = 0.000002`
- `mc_cpu_qmc_rust_randomized_halton_generation` (`standard_normal_generation_randomized_halton`): `55.787 ms` per run, `normal_mean_abs = 0.000063`
- `mc_cpu_qmc_scipy_qmc_halton_generation` (`standard_normal_generation_randomized_halton`): `145.549 ms` per run, `normal_mean_abs = 0.000017`
- `mc_cpu_qmc_rust_latin_hypercube_generation` (`standard_normal_generation_latin_hypercube`): `40.452 ms` per run, `normal_mean_abs = 0.000000`
- `mc_cpu_qmc_scipy_qmc_lhs_generation` (`standard_normal_generation_latin_hypercube`): `195.598 ms` per run, `normal_mean_abs = 0.000000`
- `mc_cpu_gaussian_uncertainty_rust_pseudorandom`: `3.268 ms` per run, `abs_error_vs_analytic_mean = 0.006344`
- `mc_cpu_gaussian_uncertainty_rust_randomized_halton`: `5.652 ms` per run, `abs_error_vs_analytic_mean = 0.000056`
- `mc_cpu_gaussian_uncertainty_rust_latin_hypercube`: `2.103 ms` per run, `abs_error_vs_analytic_mean = 0.000039`
- `mc_cpu_gaussian_uncertainty_rust_scrambled_sobol`: `9.125 ms` per run, `abs_error_vs_analytic_mean = 0.000043`
